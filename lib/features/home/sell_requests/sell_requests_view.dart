...
import 'sell_piece_detail_view.dart';
import 'package:audioplayers/audioplayers.dart';
import 'package:photo_view/photo_view.dart';
import '../../../core/utils/ui_utils.dart';

class SellRequestsView extends StatefulWidget {
  const SellRequestsView({super.key});

  @override
  State<SellRequestsView> createState() => _SellRequestsViewState();
}
...
class _SellRequestsViewState extends State<SellRequestsView> {
  final controller = Get.put(SellRequestsController());
                ...
                Expanded(
                  child: controller.requests.isEmpty
                      ...
                      : ListView.separated(
                          ...
                          itemCount: controller.requests.length + (controller.isLoadingMore ? 1 : 0),
                          itemBuilder: (context, index) {
                            ...
                            return InkWell(
                              onTap: () => Get.to(() => SellPieceDetailView(requestId: r.id)),
